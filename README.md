...
The dimensionality varies by function, but the exact mathematical structure of each function is unknown. One new query point must be submitted for each function in every round.
